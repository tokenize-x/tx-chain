...
type QueryScheduledDistributionsResponse struct {
	...
	SkipDistribution       bool                    `protobuf:"varint,2,opt,name=skip_distribution,json=skipDistribution,proto3" json:"skip_distribution,omitempty" yaml:"skip_distribution"`
}
...
func (m *QueryScheduledDistributionsResponse) GetSkipDistribution() bool {
	if m != nil {
		return m.SkipDistribution
	}
	return false
}
...
var fileDescriptor_1bf0a69d5178bfb9 = []byte{
	...
	,
}
...
func (m *QueryScheduledDistributionsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipDistribution", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
