...
type Keeper struct {
	...
	AllocationSchedule          collections.Map[uint64, types.ScheduledDistribution]
	TotalScore                  collections.Map[uint64, sdkmath.Int]
	OngoingDistribution         collections.Item[types.ScheduledDistribution]
