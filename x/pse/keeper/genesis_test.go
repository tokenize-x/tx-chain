...
func TestGenesis_HardForkWithAllocations(t *testing.T) {
	...
	requireT.EqualExportedValues(
		exportedGenesis.ScheduledDistributions,
		reexportedGenesis.ScheduledDistributions,
		"re-exported genesis should match",
	)
	requireT.EqualExportedValues(
		exportedGenesis.Params,
		reexportedGenesis.Params,
		"re-exported genesis should match",
	)
