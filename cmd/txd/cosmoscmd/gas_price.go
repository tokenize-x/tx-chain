...
import (
	...
	feecli "github.com/tokenize-x/tx-chain/v7/x/feemodel/client/cli"
)
...
// addQueryGasPriceToAllLeaves adds the logic to PreRunE function of all leaf commands
...
func addQueryGasPriceToAllLeaves(cmd *cobra.Command) {
