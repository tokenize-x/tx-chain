	...
	chain.Governance.ExpeditedProposalFromMsgAndVote(
		...
		&psetypes.MsgUpdateDistributionSchedule{
			...
			Schedule: []psetypes.ScheduledDistribution{
				{ID: 2, Timestamp: uint64(distributionStartTime.Add(30 * time.Second).Unix()), Allocations: allocations},
				{ID: 3, Timestamp: uint64(distributionStartTime.Add(60 * time.Second).Unix()), Allocations: allocations},
				{ID: 4, Timestamp: uint64(distributionStartTime.Add(90 * time.Second).Unix()), Allocations: allocations},
			},
		},
